...
\newflag{ITALICIZEINDEXEDTEXT}       {true}  % Controls whether indexed text becomes italicized in the body text
...
\declareabbreviation  {lackoftime}{its limited extent in time}
...
\declareindexkey      {depth}
\declareindexkeypair      {depth}{depths}
