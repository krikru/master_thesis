...
\declareacronyms{GPU}   {graphics processing}{unit} \index{processing unit!graphics!see{graphics processing unit}}
...
\declareindexkey      {timestep}
\declareindexkeypair      {timestep}{timesteps}
