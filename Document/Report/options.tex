...
% Sections
\newrobustcmd  {\secpref}   [1]{Section~\ref{#1}}
\newrobustcmd  {\secprefs}  [1]{Section\xspace}
% Appendices
...
\declareacronyms{MD}    {molecular}{dynamics} \idxs{simulation!molecular dynamics|see{molecular dynamics}} \idxs{method!molecular dynamics|see{molecular dynamics}}
