...
\begin{figure}
    \setlength{\unitlength}{.175\textwidth}
    \centering
    \begin{tikzpicture}[x=\unitlength,y=\unitlength,font=\large]
        % Origin
        \coordinate (O) at (0,0);
        % Angles
        \def\inangle{30}
