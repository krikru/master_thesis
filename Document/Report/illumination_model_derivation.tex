...
\begin{figure}
    ...
    \centering
    \subcaptionbox{\label{fig:kokoka}}[.415\textwidth]{
        \begin{tikzpicture}[x=\unitlength,y=\unitlength,font=\large]
            ...
            %\draw (-2,1) -- ++(-60:.5)
            %      (-2,1) -- ++(-30:.5);
            %\draw (-2,1) ++(-60:.4) arc (-60:-30:.4);
            
        \end{tikzpicture}
    }
    \subcaptionbox{\label{fig:kokokb}}[.575\textwidth]{
        \begin{tikzpicture}[x={(.035\textwidth,0)},y={(0,.035\textwidth)},z={(-.385*.035\textwidth,-.385*.035\textwidth)}]
            % Front side
