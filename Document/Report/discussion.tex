...
\begin{itemize}
    ...
    \item Handling of high Courant numbers (described by \citeauthor{Stam1999} \citep{Stam1999}),
    ...
    \item Handling of high speeds of sound if the fluids are assumed to be compressible (described by \citeauthor{Kwatra2009} \citep{Kwatra2009}),
