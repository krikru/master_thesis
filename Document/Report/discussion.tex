...
\begin{itemize}
    ...
    \item Handling of large Courant numbers (described by among others \citeauthor{Stam1999} \citep{Stam1999} and \citeauthor{Lentine2012} \citep{Lentine2012}),
    \item Solving \idxs{pressure Poisson}{equation} (see \secref{sec:pressure_poison_equation_solution}),
    \item Handling of high speeds of sound if the fluids are assumed to be compressible (described by \citeauthor{Kwatra2009} \citep{Kwatra2009}), and
