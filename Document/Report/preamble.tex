...
\newrobustcmd{\nspace}{\!\!}
\newrobustcmd{\blankpage}{\clearpage\thispagestyle{fancy}\renewcommand{\headrulewidth}{0pt}\chead{}\cfoot{}\IFDEBUGELSE{\begin{center}\large\textit{This page is intentionally left blank}\end{center}}{\ }\clearpage}
% % % Text color
