...
\begin{figure}
    \centering
    \subcaptionbox{\label{fig:transformedkernelcomparison}}[.43\textwidth]{\input{comparison.tex}}
    \subcaptionbox{\label{fig:transformedkernelratio}}[.53\textwidth]{\input{ratio.tex}}
