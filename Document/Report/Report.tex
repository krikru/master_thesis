...
% "--": En-dash, used for number ranges, to mark off nested clauses and phrases (use)
% "---": Em-dash, used to mark off nested clauses and phrases (don't use)
