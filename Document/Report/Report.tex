...
\begin{itemize}
    ...
    \item The water should interact with moving objects (see e.g.: \textit{\href{http://physbam.stanford.edu/~fedkiw/papers/stanford2010-04.pdf}{Numerically Stable Fluid-Structure Interactions Between Compressible Flow and Solid Structures}}, Immersed Boundary Method)
\end{itemize}
...
\subsection{Moving mesh for regions with high Courant number}

\subsection{Perfectly matched layers}

\subsection{Incompressibility or semi-incompressibility}
...
\subsection{Sharpening of various advected fields}

\subsubsection{Backward Error Compensation and Forward Error Correction}
...
\begin{itemize}
    ...
    \item Applied to the velocity field: \textit{\href{http://www.gvu.gatech.edu/~jarek/papers/FlowFixer.pdf}{FlowFixer: Using BFECC for Fluid Simulation}}
\end{itemize}
