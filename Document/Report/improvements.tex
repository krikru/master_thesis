...
[YOUTUBE]c3JSbhgsoGg[/YOUTUBE]

By looking at the next video, I managed to get another clue about a trick that is probably used to make the foam that is formed on top of the surface look better. It looks like the particles are attracting each other, in order to prevent them from becoming just a homogenous grey mass on the surface of the water (for example, thin lines of foam will form where there were previously weak broad bands). Maybe this corresponds to some inherent property of sea foam bubbles to bind to each other. Anyway, here's the video:

[YOUTUBE]isXNkTiiAYQ[/YOUTUBE]