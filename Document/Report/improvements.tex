...
The problem of generating the isosurface with the marching cubes algorithm when the domain that is to be rendered contains LOD transitions is well known, and remedies exist. For example, in a work by \citeauthor{Lengyel2010} from \citeyear{Lengyel2010} \citep{Lengyel2010}, this is remedied for the case where the cubes used by the algorithm are modeled as an \octree.
