...
We have the \LBM, which has connections to \idxs{cellular}{automata} and which solves the \idxs{discrete}{Boltzmann equation}\index{equation!discrete Boltzmann|see{discrete Boltzmann equation}}. As explained by \citet{Thurey2006}, the \LBM approximates the Navier--Stokes equations without the need for an iterative solver by relaxing the incompressibility constraint.
