...
%TODO: Use Piponet's paper as main reference instead of Losasso's?
...
\begin{equation} %\label{eq:continuity_equation_time_discretized}
\rho_{n+1} \,=\, \rho_{n} - \Delta t\,(\vec{u}_{n}\cdot\nabla\rho_{n} + \rho_{n}\nabla\cdot\vec{u}_{n}),
\end{equation}

\begin{equation} %\label{eq:continuity_equation_time_discretized}
\rho_{n+2} \,=\, \rho_{n+1} - \Delta t\,(\vec{u}_{n+1}\cdot\nabla\rho_{n+1} + \rho_{n+1}\nabla\cdot\vec{u}_{n+1}),
\end{equation}
...
\nabla\cdot\vec{u}_{n+1} \,=\, \frac{\rho_{n} - 1}{\Delta t}.
\end{equation}
