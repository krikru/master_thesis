...
The total number of cells $N_{\text{t}}$ used in the simulationcan can be \approximated by a \idxs{double}{series} containing the thicknesses of the different LOD layers and the number of cells visible at the surface that belong to each \LOD, accoring to
